...
<head>
  ...
  <meta name="viewport" content="width=device-width">
	<link id="stylecall" rel="stylesheet" href="wampthemes/modern-ui/style.css" />
...
<body>
  <div id="head">
	...
	<img class="resize-img" src="wampthemes/modern-ui/img/gifLogo1.gif">
        ...
        <h2>{$langues['titreConf']}</h2>
	        <dl class="content">
		        ...
		        <dt>{$langues['server']}</dt>
					...
					<div class="config-margin">
		        <dt>{$langues['versp']}</dt>
		            <dd><small style='color:blue;'>[Apache module]&nbsp;</small>&nbsp;{$phpVersion}&nbsp;-&nbsp;<a href='http://{$langues['docp']}'>
					
					{$langues['documentation-of']} PHP</a>&nbsp;-&nbsp;{$popupPHPExtLink}</dd>
		        {$PhpAllVersionsNotFcgi}
		        		<dd><small style='color:green;'>[FCGI]</small>&nbsp;{$PhpAllVersions}</dd></div>
					<div class="config-margin no-margin">
						{$DBMSTypes}
						</div>
	        </dl>
      </div>
